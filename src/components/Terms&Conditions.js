        ...
        <View style={[styles.CommentView, { color: theme.textColor }]}>
          <ScrollView>
            <View style={styles.Titleview}>
              ...
              <Text
                style={[styles.DescriptionStyle, { color: theme.textColor }]}
              >
                ...
                abusive users. We reserve the right to not post any videos that
                we deem inappropriate or subversive to the spirit of our
                platform.
              </Text>
            </View>
            <View style={styles.Titleview}>
            ...
            <View style={styles.Titleview}>
              ...
              <Text
                style={[styles.DescriptionStyle, { color: theme.textColor }]}
              >
                BMT expects every video-share to contain authentic stories of
                truthfulness and honesty without lies fabrications or
                exaggerations.
              </Text>
              <Text
                style={[styles.DescriptionStyle, { color: theme.textColor }]}
              >
                BMT is not responsible for stories or details within a story
                that may turn out to be falsified by the video-sharer. BMT
                ...
                BMT discovers that any part of your story is false, your account
                will be suspended and your video removed permanently.
              </Text>
            </View>
            <View style={styles.Titleview}>
              <Text style={[styles.Heading, { color: theme.textColor }]}>
